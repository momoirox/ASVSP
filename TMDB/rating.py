...
pages = range(1, 250)  # get pages 1 to 25
movie_data = []
# set up TMDb API parameters
api_key = YOUR_API_KEY
base_url = "https://api.themoviedb.org/3/"
movie_path = "movie/now_playing"
review_path = "movie/{movie_id}/reviews"
language = "en-US"
...
final_df.write.mode("overwrite").csv(HDFS_NAMENODE + "/data/movies_and_reviews.csv", header=True)
